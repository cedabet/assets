...
(function () {
    ...
    if (isFirstLoad) {
        setTimeout(function () {
            ...
            } else if (sportspath === "/az/e-sport") {
            } else if (sportspath === "/az/vip") {
                createVipExperience();
            } else if (sportspath === "/az/latest-big-wins") {
                clearDynamicContent();
                LandingPage();
            } else if (sportspath !== "/az/" && sportspath !== "/az") {
                clearDynamicContent();
            }
            isFirstLoad = false;
        }, 400);
    ...
    function handlePageScripts(path) {
        setTimeout(function () {
            ...
            if (path === "/az/" || path === "/az") {
                ...
                clearDynamicContent();
            } else if (path === "/az/e-sport") {
                clearDynamicContent();
            } else if (path !== "/az/sportsbook") {
                clearDynamicContent();
            } else if (path === "/az/latest-big-wins") {
                LandingPage();
            } else if (path !== "/az/sportsbook") {
                clearDynamicContent();
            }
...
function insertCedaTVButton() {
  ...
  headerActions.insertBefore(cedaTVLink, headerActions.firstChild);*/
    ...
    if (!document.getElementById("partnership-button")) {
        ...
        partnershipLink.href = "/az/affiliate"; // Gerekirse değiştirin
        ...
        const partnershipText = document.createTextNode("Tərəfdaşlıq");
...
function addMenuElement() {
    ...
    const menuItems = [
        {
            id: "custom-item-menu",
            href: "/az/casino/group/table-games",
            text: "Stolüstü Oyunları",
            iconClass: "fa-solid fa-certificate",
        },
        {
            id: "custom-item-bigwins",
            href: "/az/latest-big-wins",
            text: "Son Böyük Qələbələr",
...
function CreateCedaOriginal() {
    const games = [
        {
            name: "Plinko",
            url: "https://cedabet.com/az/casino/games/ebetlab-plinko-originals",
            img: "https://cedabet.github.io/assets/images/plinko.jpg",
        },
        {
            name: "Mines",
            url: "https://cedabet.com/az/casino/games/ebetlab-mines-originals",
        ...
        {
            name: "Limbo",
            url: "https://cedabet.com/az/casino/games/hacksaw-limbo",
            img: "https://cedabet.github.io/assets/images/limbo.jpg",
        },
        {
            name: "Dice",
            url: "https://cedabet.com/az/casino/games/ebetlab-dice-originals",
...
function CreateCedaOriginalTwo() {
    const games = [
        ...
        {
            name: "roulette",
            url: "https://cedabet.com/az/casino/games/evolution-roulette",
...
function createSocialSection() {
    ...
    if (document.getElementById("telegram-section")) {
        console.log("Telegram section zaten mevcut, devam etmiyorum.");
...
İCMAIMIZA QOŞULUN
  ...
  `;
    ...
    Eksklüziv bonuslar və ani kazino yeniliklərini əldə edin
    ...
    @keyframes games-scroll {
        ...
        customContainer.innerHTML = `
             <div class="containers">
                 ...
                 <div class="tagline">Premium Oyun Təcrübəsi</div>
...
<h2 class="section-title">Seçilmiş Oyunlar</h2>


    <div class="slider-container">
        <div class="slider-track">

            <a href="/az/casino/games/pragmaticplay-zeus-vs-hades-gods-of-war" class="game-item">
            ...
            <a href="/az/casino/games/pragmaticplay-wild-west-gold" class="game-item">
            ...
            <a href="/az/casino/games/pragmaticplay-buffalo-king" class="game-item">
            ...
            <a href="/az/casino/games/pragmaticplay-fruit-party" class="game-item">
            ...
            <a href="/az/casino/games/pragmaticplay-the-dog-house-dog-or-alive" class="game-item">
            ...
            <a href="/az/casino/games/pragmaticplay-starlight-princess" class="game-item">
            ...
            <a href="/az/casino/games/pragmaticplay-the-dog-house-multihold" class="game-item">
            ...
            <a href="/az/casino/games/pragmaticplay-sugar-rush-1000" class="game-item">
            ...
            <a href="/az/casino/games/pragmaticplay-gates-of-olympos-1000" class="game-item">
            ...
            <a href="/az/casino/games/pragmaticplay-sweet-bonanza-1000" class="game-item">
            ...
            <a href="/az/casino/games/pragmaticplay-big-bass-hold-spinner-megaways" class="game-item">
      ...
      <!-- Duplicated games with links -->
         ...
         <a href="/az/casino/games/pragmaticplay-zeus-vs-hades-gods-of-war" class="game-item">
            ...
            <a href="/az/casino/games/pragmaticplay-big-bass-hold-spinner-megaways" class="game-item">
             ...
             <h2 class="section-title">Son Böyük Qələbələr</h2>
			...
			Bütün oyunlardan toplanan nəhəng jackpot! Hər mərc ilə artır.
                         ...
                         <div class="jackpot-card">
                             ...
                             <div class="jackpot-description">
                                Böyük qazanma fürsəti! Uğurunuzu sınayın.
                         ...
                         <div class="jackpot-card">
                             ...
                             <div class="jackpot-description">
                           Ani qələbələr üçün ideal seçim – sürətli, əyləncəli və qazandıran!
    ...
    function createInitialWinners() {
        for (let i = 0; i < 4; i++) {
            ...
            winItem.innerHTML = `
                <p><strong>Oyunçumuz ${winnerName}</strong>
            </p> <p><strong>${game}</strong> oyunundan <strong>${winAmount}</strong> 
            qazandı.</p> <p>Təbriklər və uğurlar!</p>
    ...
    function addRandomPlayingCounts() {
        ...
        gameItems.forEach((item) => {
            ...
            playingSpan.textContent = `${randomCount} istifadəçi oynayır`;
...
function addEliteCardToSidebar() {
    ...
    card.onclick = () => {
        if (confirm("Mobil Proqramımızı Yükləyin..!")) {
    ...
    title.textContent = "Mobil Tətbiq";

    const subtitle = document.createElement("p");
    subtitle.className = "elite-card__subtitle";
    subtitle.textContent = "İndi yükləyin! ";
