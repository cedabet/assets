        ...
        setTimeout(function () {
		 ...
		 // toggleNightModal('https://cedabet.github.io/assets/images/50kayıp-re.jpg');     
          ...
          bonusTabCustomReplace();
            ...
            //    checkModal();
            //     createSocialSection();
             addScrollingText("BİR SONRAKİ GÜNCEL ADRESİMİZ cedabet753.com'dur. LÜTFEN SAHTE SİTELERE İTİBAR ETMEYİNİZ.");
...
function insertCedaTVButton() {
  ...
  cedaTVLink.href = 'https://cedabettv103.com';
...
// WhatsApp butonu
if (!document.getElementById("ceda-wp-button")) {
    const cedaWpLink = document.createElement("a");
    cedaWpLink.id = "ceda-wp-button";
    cedaWpLink.href = "https://bit.ly/m/CedaBETViP";
    cedaWpLink.target = "_blank";
    cedaWpLink.className = "header-custom-button custom d-flex px-3 align-items-center text-white";

    const wpIcon = document.createElement("i");
    wpIcon.className = "fa-brands fa-whatsapp"; // 

    const wpText = document.createTextNode("WhatsApp");

    cedaWpLink.appendChild(wpIcon);
    cedaWpLink.appendChild(wpText);

    // İlk sıraya ekle
    headerActions.insertBefore(cedaWpLink, headerActions.firstChild);
}
...
if (!document.getElementById("partnership-button")) {
    ...
    partnershipLink.href = "/tr/affiliate";
    ...
    // WhatsApp butonundan sonra ekle
    const whatsappButton = document.getElementById("ceda-wp-button");
    if (whatsappButton && whatsappButton.nextSibling) {
        headerActions.insertBefore(partnershipLink, whatsappButton.nextSibling);
    } else {
        headerActions.appendChild(partnershipLink);
    }
}
...
if (!document.getElementById("ceda-tv-button")) {
    ...
    // Ortaklık butonundan sonra ekle
...
function addMenuElementTwo() {
    ...
    if (sidebarLinks) {
            ...
            const newHTML = `
               <div style="width: 100%;display:flex;gap:10px;">
                     <a id="${elementId}" class="sidebar__link sidebar__link--casino" href="/tr/promotions" style="
                         background: url('https://cedabet.github.io/assets/images/promo-re.png') left center / cover no-repeat;
                         width: 100%;
                         margin-bottom: 17px;
                         margin-top: -10px;
		        ...
		        <a id="${elementId2}" class="sidebar__link sidebar__link--casino" target="_blank" href="https://cedabettv103.com/" style="
     ...
     <a id="${elementId3}" class="sidebar__link sidebar__link--casino" target="_blank" href="https://t.me/cedabet" style="
                         background: url('https://cedabet.github.io/assets/images/tg-re.png') left center / cover no-repeat;
                         width: 100%;
                         margin-bottom: 17px;
                         box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -2px 0px inset;
                     ">
    ...
    const games = [
        {
            ...
            img: "https://cedabet.github.io/assets/images/plinkore.png",
        },
        {
            name: "Mines",
            url: "/tr/casino/games/ebetlab-mines-originals",
            img: "https://cedabet.github.io/assets/images/minesre.png",
        },
        {
            name: "Keno",
            url: "/tr/casino/games/ebetlab-keno-originals",
            img: "https://cedabet.github.io/assets/images/kenore.png",
        },
        {
            name: "Limbo",
            url: "/tr/casino/games/hacksaw-limbo",
            img: "https://cedabet.github.io/assets/images/limbore.png",
        },
        {
            name: "Dice",
            url: "/tr/casino/games/ebetlab-dice-originals",
            img: "https://cedabet.github.io/assets/images/dicere.png",
        },
        {
            name: "Blackjack",
            url: "/tr/casino/games/evolution-blackjack",
            img: "https://cedabet.github.io/assets/images/bjre.png",
        },
        {
            name: "Aviator",
            url: "/tr/casino/games/spribe-aviator",
            img: "https://cedabet.github.io/assets/images/aviatorre.png",
        },
    ];
    ...
    const games = [
        {
            ...
            img: "https://cedabet.github.io/assets/images/poker-re.png",
            imgMobile: "https://cedabet.github.io/assets/images/Poker.avif",
        },
        {
            name: "BlackJack",
            url: "/tr/casino/games/evolution-blackjack",
            img: "https://cedabet.github.io/assets/images/blackjack-re.png",
            imgMobile: "https://cedabet.github.io/assets/images/Bj.avif",
        },
        {
            name: "roulette",
            url: "/tr/casino/games/evolution-roulette",
            img: "https://cedabet.github.io/assets/images/roulette-re.png",
...
function createWhatsAppBadge(phoneNumber = '66968181373') {
...
/*function fixTabsNav() {
  ...
  // 2. Kalan sekmelerden ilkini (örneğin "Aktif") aktif yap
  ...
  if (remainingButtons.length > 0) {
    ...
    // İlk butona "active" class'ı ekle
...
function initCedaBannerWatcher() {

  const BANNER_ID = "ceda-banner";
  const STYLE_ID  = "banner_style";

  const interval = setInterval(() => {

    // Banner zaten varsa → dur
    ...
    const ledWrapper = document.getElementById("ceda-originals");
	...
	gap: 15px;
        ...
        @media(max-width:992px){
          .ceda-sec1{display:none!important;}
          .ceda-row{flex-direction:column;gap:12px;}
        }
      `;
      document.head.appendChild(style);
    }
    ...
    banner.id = BANNER_ID;
    banner.innerHTML = `
      <div class="section" id="shortcuts" style="margin:0;width:100%;">
...
<div class="ceda-social-links">
  <a href="https://www.facebook.com/people/Ceda-Bet" target="_blank" rel="noopener noreferrer" class="ceda-social-link">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="26" height="26" style="fill: #1fa6ed;">
      <path d="M12.001 2.002c-5.522 0-9.999 4.477-9.999 9.999 0 4.99 3.656 9.126 8.437 9.879v-6.988h-2.54v-2.891h2.54V9.798c0-2.508 1.493-3.891 3.776-3.891 1.094 0 2.24.195 2.24.195v2.459h-1.264c-1.24 0-1.628.772-1.628 1.563v1.875h2.771l-.443 2.891h-2.328v6.988C18.344 21.129 22 16.992 22 12.001c0-5.522-4.477-9.999-9.999-9.999z"></path>
    </svg>
    <div class="ceda-hover-bg"></div>
  </a>

  <a href="https://x.com/cedabet?s=21" target="_blank" rel="noopener noreferrer" class="ceda-social-link">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="22" height="22" style="fill: #1fa6ed;">
      <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"></path>
    </svg>
    <div class="ceda-hover-bg"></div>
  </a>

  <a href="https://www.instagram.com/cedabet" target="_blank" rel="noopener noreferrer" class="ceda-social-link instagram">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="26" height="26" style="fill: #1fa6ed;">
      <path d="M12 2c2.717 0 3.056.01 4.122.06 1.065.05 1.79.217 2.428.465.66.254 1.216.598 1.772 1.153a4.908 4.908 0 0 1 1.153 1.772c.247.637.415 1.363.465 2.428.047 1.066.06 1.405.06 4.122 0 2.717-.01 3.056-.06 4.122-.05 1.065-.218 1.79-.465 2.428a4.883 4.883 0 0 1-1.153 1.772 4.915 4.915 0 0 1-1.772 1.153c-.637.247-1.363.415-2.428.465-1.066.047-1.405.06-4.122.06-2.717 0-3.056-.01-4.122-.06-1.065-.05-1.79-.218-2.428-.465a4.89 4.89 0 0 1-1.772-1.153 4.904 4.904 0 0 1-1.153-1.772c-.248-.637-.415-1.363-.465-2.428C2.013 15.056 2 14.717 2 12c0-2.717.01-3.056.06-4.122.05-1.066.217-1.79.465-2.428a4.88 4.88 0 0 1 1.153-1.772A4.897 4.897 0 0 1 5.45 2.525c.638-.248 1.362-.415 2.428-.465C8.944 2.013 9.283 2 12 2zm0 1.802c-2.67 0-2.986.01-4.04.059-.976.045-1.505.207-1.858.344-.466.182-.8.398-1.15.748-.35.35-.566.683-.748 1.15-.137.353-.3.882-.344 1.857-.048 1.055-.058 1.37-.058 4.04 0 2.67.01 2.986.058 4.04.045.976.207 1.505.344 1.858.182.466.399.8.748 1.15.35.35.683.566 1.15.748.353.137.882.3 1.857.344 1.054.048 1.37.058 4.04.058 2.67 0 2.987-.01 4.04-.058.976-.045 1.505-.207 1.858-.344.466-.182.8-.398 1.15-.748.35-.35.566-.683.748-1.15.137-.353.3-.882.344-1.857.048-1.055.058-1.37.058-4.04 0-2.67-.01-2.986-.058-4.04-.045-.976-.207-1.505-.344-1.858a3.097 3.097 0 0 0-.748-1.15 3.098 3.098 0 0 0-1.15-.748c-.353-.137-.882-.3-1.857-.344-1.054-.048-1.37-.058-4.04-.058zm0 3.063a5.135 5.135 0 1 1 0 10.27 5.135 5.135 0 0 1 0-10.27zm0 8.468a3.333 3.333 0 1 0 0-6.666 3.333 3.333 0 0 0 0 6.666zm6.538-8.469a1.2 1.2 0 1 1-2.4 0 1.2 1.2 0 0 1 2.4 0z"></path>
    </svg>
    <div class="ceda-hover-bg"></div>
  </a>

  <a href="https://t.me/cedabet" target="_blank" rel="noopener noreferrer" class="ceda-social-link">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" style="fill: #1fa6ed;">
   ...
   // ledWrapper.parentNode.insertBefore(banner, ledWrapper);
    ledWrapper.insertAdjacentElement('afterend', banner);
    // Tamamlandı → interval durur
    clearInterval(interval);
